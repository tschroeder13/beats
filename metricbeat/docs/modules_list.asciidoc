...
|<<metricbeat-module-ldap,LDAP>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-ldap-ldapsearch,ldapsearch>> beta[]  
