...
func (d *wrapperDriver) cmd(ctx context.Context, command string, arg ...string) *exec.Cmd {
	...
	// args = append(args, "--no-ansi", "--project-name", d.Name) //option '--no-ansi' is DEPRECATED ! Please use '--ansi' instead.
	args = append(args, "--ansi", "--project-name", d.Name) //option '--no-ansi' is DEPRECATED ! Please use '--ansi' instead.
